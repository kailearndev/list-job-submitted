    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _userModel["default"].find().select("-password -companies");
        case 3:
          data = _context.sent;
          res.status(200).json({
            statusCode: 200,
...
var updateUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, _req$user, role, userId, user;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          id = req.params.id; // ID của user cần cập nhật
          _req$user = req.user, role = _req$user.role, userId = _req$user.id; // Role và ID từ thông tin người dùng đã xác thực
          // Kiểm tra ID hợp lệ
          if (_mongoose["default"].Types.ObjectId.isValid(id)) {
            _context3.next = 5;
            break;
        ...
        case 7:
          _context3.next = 9;
          return _userModel["default"].findByIdAndUpdate(id, req.body, {
            "new": true
          });
        case 9:
          user = _context3.sent;
        ...
        case 15:
          ...
          console.error("Error updating user:", _context3.t0.message);
          res.status(500).json({
            statusCode: 500,
            error: "Internal server error"
          });
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return (0, _userModel["default"])(req.body).save();
        case 3:
          data = _context5.sent;
          res.status(200).json({
            statusCode: 200,
